...
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    ...
    when 9 then return "A really tough combatant. Both her kicks and punches really hurt..."
    when 10 then return "A fox girl. I think they're pretty rare."
    when 11 then return "An archeologist from Haab."
    when 12 then return "An archeologist from Haab."
    when 13 then return "An archeologist from Haab."
    when 14 then return "I met her in Velis Manor. I think she might be into me..."
    when 15 then return "Turned out she was a pirate all along."
    when 16 then return "A common pirate."
    when 17 then return "The captain of the pirates I fought when I tried to get to Belbasa. They treat her like a mother."
    when 18 then return "I didn't think mermaids were real until I met her. I wonder what would have happened if someone other than me had disturbed her."
    when 19 then return "The bride I stole a dress and a ring from. I still feel pretty bad about that..."
    when 20 then return "A soldier from Cherisa's Army who was stationed in Ghiaccio."
    when 21 then return "She's a formidable soldier. I doubt I could have defeated her on my own."
    when 22 then return ""
    when 23 then return ""
    when 24 then return ""
    when 25 then return "A girl from the beach near Armark."
    when 26 then return "A girl from the beach near Armark."
    when 27 then return "Apparently what we did in Ghiaccio got her promoted. I wonder where she is now."
    when 28 then return "She seems less experienced than some of the other pirates. She probably joined the crew more recently."
    when 29 then return "An assassin working for the Gray Lynx guild. She really doesn't approve of me rescuing captives from their camp."
    when 30 then return "A girl in Ghiaccio who pretended to be an angel."
    when 31 then return "A girl from the beach near Armark."
    when 32 then return "I rescued her from the Ghiaccio Manor's basement. She's really tough, but she also has a sweet side."
    when 33 then return "A catgirl from the Lost Forest."
    when 34 then return "The shopkeeper from Huston Village. Apparently she's Esther's cousin."  
    when 35 then return "A common villager."
    when 36 then return "A common villager."
    when 37 then return "A common villager."
    when 38 then return "A common villager."
    when 39 then return "A warrior from one of the native tribes in Jormunga Jungle."
    when 40 then return "An archer from one of the native tribes in Jormunga Jungle."
    when 41 then return "A shaman from one of the native tribes in Jormunga Jungle."
    when 42 then return "The queen of the tribe I met in Jormunga Jungle. She's pretty cold..."
    when 43 then return "A burglar. She seems pretty good at escaping..."
    when 44 then return "The leader of the settlers who were sent to Jormunga by the Kingdom."
    when 45 then return "A girl I encountered in Haab Desert."
    when 46 then return "A girl I encountered in Haab Desert."
    when 47 then return "A student from Aurealis Academy. She's really good with magic, but not very good at escaping ropes..."
    when 48 then return "A mage from Aurealis Academy. She wanted to turn us into frogs!"
    when 49 then return "A mage from Aurealis Academy. She uses Fire spells."
    when 50 then return "A mage from Aurealis Academy. She uses Wind spells."
    when 51 then return "An adept mage from Aurealis Academy. She uses Lightning spells."
    when 52 then return "An adept mage from Aurealis Academy. She uses Water spells."
    when 53 then return "An adept mage from Aurealis Academy. She uses Fire and Darkness spells."
    when 54 then return "An adept mage from Aurealis Academy. She uses Fire and Darkness spells."
    when 55 then return "A second-year student from Aurealis Academy. She was in the garden with all the seeker vines..."
    when 56 then return "A third-year student from Aurealis Academy. She is the sister of Aurora Midnight."
    when 57 then return "A second-year student from Aurealis Academy. She seems pretty popular among the other girls there."
    when 58 then return "A girl I met in Haab desert. I didn't realise those men weren't innocent merchants..."
    when 59 then return "A Dryad from the Lost Forest."
    when 60 then return "A succubus. Did I really meet her, or was it just a dream...?"
    when 61 then return "I thought these only existed in fairy tales..."
    when 62 then return "She tried to tie me up in the Florian Casino. I kind of like the outfit she gave me, though I prefer not to wear it in the guild..."
    when 63 then return "A girl who has been working for Rolina, apparently against her will."
    when 64 then return "She's been keeping an eye on Cherisa. Apparently she's been punishing Cherisaby tying her up..."
    when 65 then return "I met her in Haab Desert. She's powerful, but not very reliable."
    when 66 then return "A real angel. I wonder what it's like where she lives."
    when 67 then return "A girl who was possessed in Belbasa."
    when 68 then return "The woman behind the Belbasa incident. I heard she's in a prison now."
    when 69 then return "She's been controlling things behind the scenes all this time, using Cherisa as her puppet. I cannot forgive her for that..."
    when 70 then return "Rika and Ruki. I think they derserved the tickle treatment they received afterwards."
    when 71 then return "A bounty hunter."
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
