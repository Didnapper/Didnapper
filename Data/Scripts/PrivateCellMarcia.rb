...
{\
	...
	[\
		[\
			...
			{'text'=>'  Marcia:  What? I-I don\'t know. She did visit me personally, though.', 'talking'=>true,'proc'=>nil},\
			{'text'=>'  Marcia:  She told me that I had the honor and courage necessary to lead her forces.', 'talking'=>true,'proc'=>nil},\
			{'text'=>'  Marcia:  The position meant leaving everything behind in Velis. It was worth it if I could truly please my Queen… but I failed her…', 'talking'=>true,'proc'=>nil},\
			{'text'=>'  Suki1:  I\'m sorry… I didn\'t mean to-', 'talking'=>false,'proc'=>nil},\
			{'text'=>'  Marcia:  No, I don\'t want pity. It was a fair battle, and you have been gracious in victory.', 'talking'=>true,'proc'=>nil},\
		...
		[\
			...
			{'text'=>'  Marcia:  That\'s Queen Cherisa to you!', 'talking'=>true,'proc'=>method(:face_default)},\
			...
			{'text'=>'  Marcia:  Humph! You already know what we were doing. We were to seal off the town,', 'talking'=>true,'proc'=>nil},\
			{'text'=>'  Marcia:  Take complete control of the area and everyone there for the kingdom.', 'talking'=>true,'proc'=>nil},\
			{'text'=>'  Suki1:  Why? For what purpose? What is Cherisa planning?', 'talking'=>false,'proc'=>nil},\
			{'text'=>'  Marcia:  Hehe. Listen, kidnapper, I\'m a solider. I take orders and I give orders.', 'talking'=>true,'proc'=>method(:face_default)},\
		...
		[\
			...
			{'text'=>'  Marcia:  Just remember, one day Queen Charisa will rescue me. And when that day comes I\'ll drag you filthy mongrels behind me in muzzles and chains. ', 'talking'=>true,'proc'=>nil},\
		...
		[\
			...
			{'text'=>'  Suki1:  Well, you\'re right about the knots, I\'ll give you that; but there has to be more to this than just simple practicality.', 'talking'=>false,'proc'=>nil},\
			{'text'=>'  Marcia:  Why don\'t you ask Cherisa herself? Oh wait, kidnapping scum don\'t get audiences with the Queen, now do they.', 'talking'=>true,'proc'=>nil},\
			...
			{'text'=>'  Marcia:  Y-You\'re not thinking of… Oh, don\'t you dare! Hmmph! These damn ropes! I swear, if I wasn\'t tied up…  ', 'talking'=>true,'proc'=>method(:face_default)}\
		],\
		[\
			...
			{'text'=>'  Marcia:  Humph… luck! Listen, if you hand yourself in, I promise I\'ll throw in a good word with Cherisa. It\'s your only chance.', 'talking'=>true,'proc'=>nil},\
		...
		[\
			...
			{'text'=>'  Suki1:  You should apologise. That would make things smoother for everybody.', 'talking'=>false,'proc'=>nil},\
	...
	[\
		{\
			...
			[\
				...
				{'text'=>'  Marcia:  Shut up.', 'talking'=>true,'proc'=>method(:face_default)},\
			...
			[\
				...
				{'text'=>'  Marcia:  … Don\'t condescend to me.', 'talking'=>true,'proc'=>method(:face_default)},\
			...
			'sadness' =>\
			[\
				{'text'=>'  Suki1:  I don\'t think you have to worry about this little setback. After all, someone of your reputation…', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  Do you have any idea what you\'ve done to my reputation?', 'talking'=>true,'proc'=>method(:face_default)},\
				{'text'=>'  Suki1:  N-No…?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  You\'ve ruined it. Now go to hell. You and the rest of the vermin that inhabit this nest.', 'talking'=>true,'proc'=>nil}\
			],\
			'fear' =>\
			[\
				{'text'=>'  Suki1:  Please don\'t worry, Marcia. I\'d never think to harm someone as lovely as you.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  Who do you think you\'re dealing with?', 'talking'=>true,'proc'=>method(:face_default)},\
			...
			[\
				...
				{'text'=>'  Suki1:  H-Hold on. I just want to know if…', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  If I weren\'t trussed and helpless I\'d slay you on the spot for this attempt!', 'talking'=>true,'proc'=>nil},\
		...
		{\
			...
			[\
				...
				{'text'=>'  Marcia:  What kind of compliment is that?', 'talking'=>true,'proc'=>method(:face_default)},\
				{'text'=>'  Suki1:  Well, I\'m just saying that…', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  You\'re saying I\'m a gracious loser. Got it. Now leave me alone.', 'talking'=>true,'proc'=>nil},\
				{'text'=>'  Suki1:  …You\'re not acting very gracious right now…', 'talking'=>false,'proc'=>nil}\
			],\
			'happiness' =>\
			[\
				{'text'=>'  Suki1:  You know, you look so much younger when you smile.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  …', 'talking'=>false,'proc'=>method(:face_default)},\
			...
			'sadness' =>\
			[\
				{'text'=>'  Suki1:  I don\'t think you have to worry about this little setback.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Suki1: After all, someone of your reputation will be just fine when we\'ve settled all of this.', 'talking'=>false,'proc'=>nil},\
			...
			[\
				...
				{'text'=>'  Suki1:  Because it\'s true. You\'re…', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  I don\'t want special treatment. All I want is the safety of my army.', 'talking'=>true,'proc'=>method(:face_default)},\
			...
			'anger' =>\
			[\
				{'text'=>'  Suki1:  I think you might just have been the toughest opponent I\'ve ever faced.', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				{'text'=>'  Suki1:  I have to say I\'ve been quite impressed with you. You\'ve been dealing with this quite well, all things considered.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  To be composed is one of the essential aspects of a Captain.', 'talking'=>true,'proc'=>method(:face_default)},\
			...
			[\
				...
				{'text'=>'  Marcia:  Do you think I\'d accept my safety over that of my friends? I know you meant well, but please don\'t say that again.', 'talking'=>true,'proc'=>nil}\
			],\
			'anger' =>\
			[\
				{'text'=>'  Suki1:  I think you might just have been the toughest opponent I\'ve ever faced. Do you think maybe when this is over you\'d like to travel with us?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  Perhaps…', 'talking'=>true,'proc'=>method(:face_default)},\
				{'text'=>'  Suki1:  That\'s grea-', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  Let me finish. Perhaps if our lives had led us down different paths… that would have been acceptable.', 'talking'=>true,'proc'=>nil},\
		...
		{\
			...
			[\
				...
				{'text'=>'  Marcia:  P-please, it is not dignified for me to be like this. Don\'t…', 'talking'=>true,'proc'=>method(:face_shy)},\
			...
			'neutral' =>\
			[\
				{'text'=>'  Suki1:  I have to say I\'m quite impressed with you. You\'ve been dealing with this quite well, all things considered.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  I try… But it\'s hard, not knowing…', 'talking'=>true,'proc'=>method(:face_default)},\
			...
			[\
				...
				{'text'=>'  Marcia:  It is not the place of a soldier to be happy. We are to be always mindful of our place in history…', 'talking'=>true,'proc'=>nil},\
				...
				{'text'=>'  Marcia:  I… I suppose I can.', 'talking'=>true,'proc'=>method(:face_default)},\
				{'text'=>'  Suki1:  I\'m glad.', 'talking'=>false,'proc'=>nil}\
			],\
			'sadness' =>\
			[\
				{'text'=>'  Sukii1:  I don\'t think you have to worry about this little setback.', 'talking'=>false,'proc'=>nil},\
				...
				{'text'=>'  Marcia:  … Heh. I didn\'t expect you of all people to say that. But… I won\'t say no. You really are an interesting girl.', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'fear' =>\
			[\
				{'text'=>'  Suki1:  Please don\'t worry, Marcia. I\'d never think to harm someone as lovely as you.', 'talking'=>false,'proc'=>nil},\
				...
				{'text'=>'  Marcia:  Huh?', 'talking'=>true,'proc'=>method(:face_default)},\
				{'text'=>'  Suki1:  You\'re beautiful, but more than that you\'re kind, caring.', 'talking'=>false,'proc'=>nil},\
				...
				{'text'=>'  Marcia:  I… by the Queen, you really are corny, but… thank you, Suki1.', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'anger' =>\
			[\
				{'text'=>'  Suki1:  I think you might just have been the toughest opponent I\'ve ever faced.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Suki1:  Do you think maybe when this is over you\'d like to travel with us?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  … Maybe', 'talking'=>true,'proc'=>nil},\
				{'text'=>'  Suki1:  Maybe? what\'s holding you back?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  Besides the obvious?', 'talking'=>true,'proc'=>nil},\
				{'text'=>'  Suki1:  Haha, I\'m sure Athena would love to have you. Once you put things behind you I\'ve no doubt you two will get on famously.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  I have my loyalty to the Queen. But… I will admit that if I didn\'t, I\'d have been happy to join.', 'talking'=>true,'proc'=>nil},\
				{'text'=>'  Suki1:  Loyalty to the Queen, huh? I will be sure to remember that.', 'talking'=>false,'proc'=>nil}\
			]\
		}\
	],\
	'insult' =>\
	[\
		{\
			...
			[\
				...
				{'text'=>'  Marcia:  I wish I\'d never hired that damn turncoat!', 'talking'=>true,'proc'=>nil}\
			],\
			'fear' =>\
			[\
			...
			'anger' =>\
			[\
				{'text'=>'  Suki1:  They\'re never coming back for you. You\'re nothing but dead weight, left behind at a moment\'s notice.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  … Enough. Just let me rot away in peace.', 'talking'=>true,'proc'=>method(:face_default)},\
		...
		{\
			...
			[\
				{'text'=>'  Suki1:  I can\'t believe you locked Athena away. The enemy of my enemy… did you just want to lose?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  I\'ll lock you both in cages once I get free!', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'fear' =>\
			[\
			...
			[\
				{'text'=>'  Suki1:  They\'re never coming back for you. You\'re nothing but dead weight, left behind at a moment\'s notice.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  I swear I\'m going to drag you back to the palace in chains, even if it\'s the last thing I do!', 'talking'=>true,'proc'=>method(:face_default)}\
			]\
		},\
		{\
			'shyness' =>\
			...
			[\
				{'text'=>'  Suki1:  You\'re such a failure. You couldn\'t even keep your soldiers safe.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  Maybe… maybe you\'re right.', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'happiness' =>\
			[\
				{'text'=>'  Suki1:  What a stupid decision to fight in a dress. Or did you want to be a fancy failure?', 'talking'=>false,'proc'=>nil},\
			...
			[\
				{'text'=>'  Suki1:  I can\'t believe you locked Athena away. The enemy of my enemy… did you just want to lose?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  (Athena… how could you?)', 'talking'=>false,'proc'=>method(:face_default)}\
			],\
			'fear' =>\
			[\
				{'text'=>'  Suki1:  So much for fair renown. I bet in one month no one will even remember your name.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  I don\'t care about that. I never did…', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'anger' =>\
			[\
				...
				{'text'=>'  Marcia:  (Who could blame them…)', 'talking'=>false,'proc'=>method(:face_default)}\
			]\
		},\
		{\
			'shyness' =>\
			[\
				{'text'=>'  Suki1:  You really were out of your league. You should have stayed in Velis. At least there you could have pretended you made a difference.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  Too cruel.', 'talking'=>true,'proc'=>method(:face_default)},\
			...
			[\
				{'text'=>'  Suki1:  I can\'t believe you locked Athena away. The enemy of my enemy… did you just want to lose?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  (I was a fool… I did this to myself…)', 'talking'=>false,'proc'=>method(:face_default)}\
			],\
			'fear' =>\
			[\
				{'text'=>'  Suki1:  So much for fair renown. I bet in one month no one will even remember your name.  ', 'talking'=>false,'proc'=>nil},\
			...
			[\
				{'text'=>'  Suki1:  They\'re never coming back for you. You\'re nothing but dead weight, left behind at a moment\'s notice', 'talking'=>true,'proc'=>nil},\
				{'text'=>'  Marcia:  (Maybe it\'s better this way. Who needs a failure in their ranks?)', 'talking'=>false,'proc'=>method(:face_default)}\
			]\
		}\
	],\
	'threaten' =>\
	[\
		{\
			...
			[\
				...
				{'text'=>'  Marcia:  Urggg (Not a maid. Please. Anything but that.)', 'talking'=>false,'proc'=>method(:face_default)}\
			],\
			'neutral' =>\
			[\
			...
			[\
				...
				{'text'=>'  Marcia:  Those brigands?! You wouldn\'t dare!', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'anger' =>\
			[\
				{'text'=>'  Suki1:  I\'m tired of you. I hear there\'s two factions battling it out in Jyouga. I can sell you as a meat shield.', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				{'text'=>'  Suki1:  I have an idea. Velis Manor needs a new maid. Maybe you can fill the vacancy.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  I\'ll get justice one day!', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'neutral' =>\
			[\
			],\
			...
			[\
				{'text'=>'  Suki1:  I\'m never going to sell you. You\'re going to stay here with me forever!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  (One day I\'ll be free… I hope…)', 'talking'=>false,'proc'=>method(:face_default)}\
			],\
			'fear' =>\
			[\
				{'text'=>'  Suki1:  If you don\'t start behaving I\'m going to sell you to the pirates!', 'talking'=>false,'proc'=>nil},\
				...
				{'text'=>'  Suki1:  What?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  Which pirates are you referring to?', 'talking'=>true,'proc'=>nil},\
				{'text'=>'  Suki1:  What does it matter?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  What kind of stupid question is that?', 'talking'=>true,'proc'=>nil},\
				{'text'=>'  Suki1:  Stop undermining me!', 'talking'=>false,'proc'=>nil}\
			],\
			'anger' =>\
			[\
				{'text'=>'  Suki1:  I\'m tired of you. I hear there\'s some settlers in Jyouga who need cheap labor.', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			'neutral' =>\
			[\
				{'text'=>'  Suki1:  I\'m going to sell you off to the Sand Storm Guild Master.', 'talking'=>false,'proc'=>nil},\
			...
			[\
				...
				{'text'=>'  Marcia:  Oh…(I feel stupid)', 'talking'=>true,'proc'=>method(:face_neutral)}\
			],\
			'fear' =>\
			[\
				{'text'=>'  Suki1:  If you don\'t start behaving I\'m going to sell you to the pirates!', 'talking'=>false,'proc'=>nil},\
				...
				{'text'=>'  Marcia:  Aren\'t we landlocked? Won\'t it be a huge pain in the ass to make that sale?', 'talking'=>true,'proc'=>method(:face_default)},\
				{'text'=>'  Suki1:  Grrrr….', 'talking'=>false,'proc'=>nil}\
			],\
			'anger' =>\
			[\
			]\
		...
		{\
			...
			[\
				...
				{'text'=>'  Marcia:  I\'d much rather be your maid.', 'talking'=>true,'proc'=>nil},\
			...
			'anger' =>\
			[\
				{'text'=>'  Suki1:  I\'m tired of you. I hear the situation in Jyouga has only gotten worse. Maybe I can sell you as a peace offering.', 'talking'=>false,'proc'=>nil},\
	...
	[\
		...
		{\
			...
			[\
				...
				{'text'=>'  Marcia:  That wasn\'t very effective…', 'talking'=>true,'proc'=>nil}\
			],\
			'sadness' =>\
			[\
				{'text'=>'  Suki1:  Take This!', 'talking'=>false,'proc'=>nil},\
			...
			[\
				{'text'=>'  Suki1:  This\'ll teach you!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  Your attacks are like the buzzing of flies… annoying but ineffective', 'talking'=>true,'proc'=>nil}\
			]\
		},\
		{\
			'shyness' =>\
	...
	[\
		...
		{\
			...
			[\
				{'text'=>'  Suki1:  Let\'s see what\'s hiding under that mask!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  No, you can\'t do thiheehehehehehahhahaha', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'neutral' =>\
			[\
				{'text'=>'  Suki1:  Tickle Tickle!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  Hehe… No!  ', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'happiness' =>\
			[\
				{'text'=>'  Suki1:  I\'m gonna tickle you!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  Heheheheh', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'sadness' =>\
			[\
				{'text'=>'  Suki1:  Cheer up!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  Nothing you dohoohoohah… argh! Enough!', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'fear' =>\
			[\
				{'text'=>'  Suki1:  This\'ll perk you up!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  Gah! I won\'t hehe let heehee you… AHAHA', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'anger' =>\
			[\
				{'text'=>'  Suki1:  Enough with the angry eyes!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  D-Damn you! I\'ll hav-haveheahaha.', 'talking'=>true,'proc'=>method(:face_default)}\
			]\
		},\
		{\
			'shyness' =>\
			[\
				{'text'=>'  Suki1:  Let\'s see what\'s hiding under that mask!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  Hehe', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'neutral' =>\
			[\
				{'text'=>'  Suki1:  Tickle Tickle!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  Hahahaha  ', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'happiness' =>\
			[\
				{'text'=>'  Suki1:  I\'m gonna tickle you!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  AHAHAHAHAHAA', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'sadness' =>\
			[\
				{'text'=>'  Suki1:  Cheer up!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  HAHAHAHAHAHA! NoooOO!! STOpHAHAHAHA!!!', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'fear' =>\
			[\
				{'text'=>'  Suki1:  This\'ll perk you up', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  OHAAhAHAaa', 'talking'=>true,'proc'=>method(:face_default)}\
			],\
			'anger' =>\
			[\
				{'text'=>'  Suki1:  Enough with the angry eyes!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  HAHAHAHAHAAAAHAHA', 'talking'=>true,'proc'=>method(:face_default)}\
			]\
		}\
	],\
	'kiss' =>\
	[\
		{\
			...
			[\
				...
				{'text'=>'  Marcia:  So this is what I\'ve been reduced to?', 'talking'=>true,'proc'=>nil}\
			],\
			'fear' =>\
			[\
			...
			[\
				...
				{'text'=>'  Marcia:  Get off me, you filthy pervert!', 'talking'=>true,'proc'=>nil}\
			]\
		},\
		{\
			'shyness' =>\
		...
		{\
			...
			[\
				{'text'=>'  Suki1:  (Smooch)', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  I\'m yours now.', 'talking'=>true,'proc'=>nil}\
			],\
			'sadness' =>\
			[\
				{'text'=>'  Suki1  (Peck)', 'talking'=>false,'proc'=>nil},\
	...
	[\
		...
		{\
			...
			[\
				{'text'=>'  Suki1:  I guess I\'ll ungag you now…', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  That felt stuffy…', 'talking'=>true,'proc'=>nil}\
			],\
			'happiness' =>\
			[\
				{'text'=>'  Suki1:  I guess you learned your lesson.', 'talking'=>false,'proc'=>nil},\
			...
			[\
				{'text'=>'  Suki1:  …', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Marcia:  We can have a dialog… just give me a chance.', 'talking'=>true,'proc'=>nil}\
			],\
			'fear' =>\
			[\
				{'text'=>'  Suki1:  See how peaceful things can be?', 'talking'=>false,'proc'=>nil},\
	...
	[\
		{\
			...
			[\
				...
				{'text'=>'  Marcia:  Get this off me!', 'talking'=>true,'proc'=>nil}\
			],\
			'sadness' =>\
			[\
	...
	[\
		{\
			...
			[\
				...
				{'text'=>'  Suki1:  You\'re loud…', 'talking'=>false,'proc'=>nil}\
			],\
			'anger' =>\
			[\
		...
		{\
			...
			'happiness' =>\
			[\
				{'text'=>'  Marcia:  I suppose thanks are in order', 'talking'=>true,'proc'=>nil},\
				{'text'=>'  Suki1:  If you must.', 'talking'=>false,'proc'=>nil}\
			],\
			'sadness' =>\
			[\
