...
{\
	...
	[\
		...
		[\
			...
			{'text'=>'  Suki1:  Oh yeah, don’t Succubi have immortality or something? How is that?', 'talking'=>true,'proc'=>nil},\
			...
			{'text'=>'  Suki1: I’m  sorry...', 'talking'=>true,'proc'=>nil},\
			{'text'=>'  Succubus: Don’t be... Not all the experiences are bad, hon.  ', 'talking'=>true,'proc'=>nil},\
		],\
		[\
			...
			{'text'=>'  Suki1: Oh, I just thought we could get to know each other a little bit b-', 'talking'=>false,'proc'=>nil},\
			{'text'=>'  Succubus: Look, dollface, you’re better off gagging me at this point...', 'talking'=>true,'proc'=>method(:face_annoyed)},\
			{'text'=>'  Succubus: You’ll get the same response.', 'talking'=>true,'proc'=>nil},\
		],\
		[\
		...
		[\
			{'text'=>'  Suki1:  For a creature of the night, you aren’t that creepy... I mean, I expected like a zombie or something.', 'talking'=>false,'proc'=>nil},\
		...
		[\
			{'text'=>'  Suki1:  Okay, fine… Please tell me your name? pretty please?', 'talking'=>true,'proc'=>nil},\
			{'text'=>'  Succubus: Well, well... what a pleasant surprise. All this for little ol’ me?', 'talking'=>true,'proc'=>method(:face_default)},\
			{'text'=>'  Suki1: So will you please tell me?', 'talking'=>true,'proc'=>nil},\
			{'text'=>'  Succubus:  I don’t know, maybe if you beg a little harder?', 'talking'=>true,'proc'=>nil},\
			{'text'=>'  Suki1:   ...', 'talking'=>true,'proc'=>nil},\
	...
	[\
		{\
			...
			[\
				...
				{'text'=>'Succubus:  Thank you, hon!', 'talking'=>true,'proc'=>method(:face_default)},\
				{'text'=>'Suki1:  Your wings too, they are just magnificient!', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			'happiness' =>\
			[\
				{'text'=>'  Suki1:  I’m impressed by how well you can pick up men!', 'talking'=>true,'proc'=>nil},\
				{'text'=>'  Succubus:  Men aren’t all I’m after, darling.', 'talking'=>true,'proc'=>nil},\
				{'text'=>'  Suki1:  Wait, what do you mean?', 'talking'=>true,'proc'=>nil},\
				{'text'=>'  Succubus: Better watch yourself, dollface.', 'talking'=>true,'proc'=>method(:face_default)},\
			],\
			'sadness' =>\
			[\
			...
			[\
				...
				{'text'=>'Succubus: ...', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				...
				{'text'=>'Succubus:  Yup, and all the cutie kidnappers too!~', 'talking'=>true,'proc'=>nil},\
			],\
			'happiness' =>\
			[\
				{'text'=>'  Suki1:  You know what, you are actually quite beautiful.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Succubus:  Heh, well darling… You aren’t too bad yourself either.', 'talking'=>true,'proc'=>method(:face_happy)},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1:  This is weird, but you are actually really fun to tie up. You actually enjoy it. Probably more than I do!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  A little bit of humiliation makes a woman beautiful, don’t you think?', 'talking'=>true,'proc'=>method(:face_default)},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1:  Is it weird that I just love watching you being tied up?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  Oh no, not at all, hun', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Succubus:  I do it all the time~', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1:  I want to tell you what all looks great about you... But then we\'d sit here all day', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  Hehehe~', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Succubus:  We have alll the time in the world~', 'talking'=>true,'proc'=>nil},\
			],\
			'shyness' =>\
			[\
		...
		{\
			...
			[\
				{'text'=>'Suki1:  You\'re a creature of lust, right?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus: Mhh? Yes I am, why do you ask?~', 'talking'=>true, 'proc'=>nil},\
				{'text'=>'Suki1:  Because you\'re making me very lustful right now~', 'talking'=>false,'proc'=>nil},\
	...
	[\
		...
		{\
			...
			[\
				...
				{'text'=>'Succubus:  I don’t have any complaints, dollface.', 'talking'=>true,'proc'=>method(:face_default)},\
			],\
			'sadness' =>\
			[\
			...
			'fear' =>\
			[\
				{'text'=>'Suki1:  What are those things on your back, misformed wings or oversized toothpicks?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  Untie me, and I\'ll show what I can do with these babies~', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1:  I though succubi were supposed to be beautiful...', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  Just ask the dozens of men I\'ve seduced', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Succubus:  Oh, and don\'t forget that kidnapper girl~', 'talking'=>true,'proc'=>nil},\
			],\
			'shyness' =>\
			[\
				{'text'=>'Suki1:  So... How did you ever become a succesfull succubus looking like that?', 'talking'=>false,'proc'=>nil},\
		...
		{\
			'neutral' =>\
			[\
				{'text'=>'Suki1:  Who would\'ve thought a little bit of rope would make you look that less like garbage...', 'talking'=>false,'proc'=>nil},\
			...
			[\
				...
				{'text'=>'  Succubus:  then, why don’t you open her up and see what’s inside?', 'talking'=>true,'proc'=>method(:face_happy)},\
			],\
			'fear' =>\
			[\
			...
			[\
				...
				{'text'=>'Succubus:  Oh, daddy loved me allright~', 'talking'=>true,'proc'=>nil},\
			],\
			'shyness' =>\
			[\
				{'text'=>'Suki1:  I would insult you... But words can\'t describe how you look', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  Feelingd can, though. And you\'re feeling very aroused right now, don\'t you, dollface?~', 'talking'=>true,'proc'=>nil},\
			]\
		},\
		{\
			'neutral' =>\
			[\
				{'text'=>'Suki1:  You know... You were awfully easy to beat. Might want to train some more.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  I\'m training... Where it matters~', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Succubus:  And you\'re being an awesome \'sparring partner\'~', 'talking'=>false,'proc'=>nil},\
			],\
			'happiness' =>\
			[\
			...
			[\
				...
				{'text'=>'  Succubus:  Sassy! You realize this just makes me want you more, right Hon?', 'talking'=>true,'proc'=>method(:face_default)},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1:  Hey, want to have- oh nevermind, you didn\'t get out yet.', 'talking'=>false,'proc'=>nil},\
			...
			[\
				{'text'=>'Suki1:  Score: Kidnapper - 1, Succubus - 0', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  Really? I\'m the one tied up, though, so really, I won~', 'talking'=>true,'proc'=>nil},\
			],\
			'shyness' =>\
			[\
				{'text'=>'Suki1:  So... How did you ever become a succesful succubus looking like that?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  Honey, that\'s exactly why I became succesful', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Succubus:  You want me to show you?~', 'talking'=>true,'proc'=>nil},\
			]\
		},\
	],\
	...
	[\
		...
		{\
			...
			[\
				...
				{'text'=>'  Succubus:  Heh, darling, you know I like it rough.', 'talking'=>true,'proc'=>method(:face_default)},\
			],\
			'sadness' =>\
			[\
				{'text'=>'  Suki1:  Looks like I’m going to need to tighten your binds to keep any thoughts of escape from arousing in your head.', 'talking'=>false,'proc'=>method(:face_happy)},\
		...
		{\
			...
			[\
				...
				{'text'=>'  Succubus:  Oh, you poor, sweet, innocent girl…', 'talking'=>true,'proc'=>method(:face_default)},\
			],\
			'sadness' =>\
			[\
				...
				{'text'=>'  Suki1:  How’s that?', 'talking'=>false,'proc'=>method(:face_shy)},\
				{'text'=>'  Succubus:  ...', 'talking'=>true,'proc'=>nil},\
			],\
			'fear' =>\
			[\
		...
		{\
			...
			[\
				...
				{'text'=>'  Succubus:  Darling, we shouldn’t even be having this conversation if you would have just gagged me already.', 'talking'=>true,'proc'=>method(:face_default)},\
			],\
			'sadness' =>\
			[\
				{'text'=>'  Suki1:  I’m re-tying all your ropes extra tight… Wouldn’t want you going anywhere, now would we?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Succubus:  Darling, the more you do this the less I would want to leave in the first place.', 'talking'=>true,'proc'=>method(:face_default)},\
			],\
			'fear' =>\
			[\
			...
			[\
				{'text'=>'Suki1:  Now... What should we do next...', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Suki1:  Tie you so that you can\'t move an inch, or tie you just tight enough that you can\'t escape, but not tighther...', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  Honey... You\'re listing the same thing twice~', 'talking'=>false,'proc'=>nil},\
			]\
		},\
	],\
	'slap' =>\
	[\
		{\
			...
			[\
				...
				{'text'=>'Succubus:  Yes! More!', 'talking'=>false,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1:  That\'s what you get for being naughty!', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				...
				{'text'=>'  Succubus:  Oh, I like it rough!', 'talking'=>true,'proc'=>method(:face_default)},\
			],\
			'sadness' =>\
			[\
				{'text'=>'  Suki1:  Stop making a fuss!', 'talking'=>false,'proc'=>nil},\
			...
			[\
				...
				{'text'=>'Succubus:  Punishment? Don\'t you mean reward?~', 'talking'=>false,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1:  Time for a little punishment.', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				{'text'=>'Suki1:  Stop making a fuss!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  I won\'t if you keep reacting like this~', 'talking'=>false,'proc'=>nil},\
			],\
			'happiness' =>\
			[\
				{'text'=>'  Suki1:  Stop making a fuss!', 'talking'=>false,'proc'=>nil},\
			...
			[\
				{'text'=>'  Suki1:  Stop making a fuss!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Succubus: Oh! feisty. I love that, honey!', 'talking'=>true,'proc'=>method(:face_default)},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1:  Stop making a fuss!', 'talking'=>false,'proc'=>nil},\
			...
			[\
				...
				{'text'=>'Succubus:  Harder!', 'talking'=>false,'proc'=>nil},\
			],\
			'shyness' =>\
			[\
				{'text'=>'Suki1:  Punishment time!', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				{'text'=>'  Suki1:  Stop making a fuss!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Succubus:  Darling, you are quiet aggressive... do me a favor and keep it up, would you?.', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'  Suki1:  Stop making a fuss!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Succubus:  Oh Yes! now... now call me demeaning names!', 'talking'=>true,'proc'=>method(:face_default)},\
				{'text'=>'  Suki1:  Errr.. what?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Succubus:  Come on, darling, do  it!', 'talking'=>true,'proc'=>nil},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1:  Let\'s do this', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  Ooh~  I approve~', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1:  There!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  More please~', 'talking'=>true,'proc'=>nil},\
			],\
			'shyness' =>\
			[\
				{'text'=>'Suki1:  Take that!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  Gladly~', 'talking'=>true,'proc'=>nil},\
			]\
		},\
	],\
	'tickle' =>\
	[\
		...
		{\
			...
			[\
				...
				{'text'=>'Succubus:  Hehehe...', 'talking'=>true,'proc'=>method(:face_default)},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1:  I wonder how ticklish you are…', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  Heeeheee…', 'talking'=>true,'proc'=>method(:face_default)},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1:  I wonder...', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  A-hahahaaa! Hehehehrubse!', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1:  I wonder...', 'talking'=>false,'proc'=>nil},\
...
#			]\
		...
		{\
			...
			[\
				{'text'=>'Suki1:  I wonder how ticklish you are…', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  Heeeheee! Honey, if you k- heeheehee! keep that up, I’ll end up…  Hahaha! Losing control of myself!', 'talking'=>true,'proc'=>method(:face_default)},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1:  I wonder…', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  Wait, what are y- Heeeheee!  Oh, dollface please d-hahaha! not  the tail, please sto- hahahah!', 'talking'=>true,'proc'=>method(:face_default)},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1:  How\'s this feeling?~', 'talking'=>false,'proc'=>nil},\
...
#			]\
	...
	[\
		{\
			...
			[\
				...
				{'text'=>'Suki1:  Mmm…', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  Mmm~  you\'re good~', 'talking'=>true,'proc'=>method(:face_happy)},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1:  Mmm…', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				...
				{'text'=>'Succubus:  I thought you\'d never ask~', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Succubus:  Mmm~', 'talking'=>true,'proc'=>nil},\
			],\
			'happiness' =>\
			[\
				{'text'=>'  Suki1:  Mmmm…', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Succubus:  Mmmm… Ahh, only a peck? You silly girl, you can do better!', 'talking'=>true,'proc'=>method(:face_default)},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1:  Kiss me~', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  Why, of course, honey~', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Succubus:  Mmm~', 'talking'=>true,'proc'=>nil},\
			],\
			'fear' =>\
			[\
		...
		{\
			...
			[\
				...
				{'text'=>'  Succubus:  Mmmm... Not bad honey, but you need practice. C\'m here...', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'  Suki1:  Mmmmm…', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				...
				{'text'=>'  Succubus: Mmmm… Sorry darling, I wasn’t done.', 'talking'=>true,'proc'=>method(:face_default)},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1:  How\'s this?~', 'talking'=>false,'proc'=>nil},\
	...
	[\
		...
		{\
			...
			[\
				{'text'=>'  Suki1:  Here, let me just...', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Succubus:  heh, heh. You’re pretty good darling, how about you teach me another lesson?', 'talking'=>true,'proc'=>nil},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1:  Let me take this off...', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				...
				{'text'=>'  Succubus:  Heh heh… Are you sure that’s all you want to take off?', 'talking'=>true,'proc'=>method(:face_happy)},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1:  Let\'s hear your voice again~', 'talking'=>false,'proc'=>nil},\
	...
	[\
		...
		{\
			...
			'happiness' =>\
			[\
				{'text'=>'  Suki1:  Raise in shine, Nightbloom!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Succubus:  Awww, five more minutes, darling.', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'  Suki1:  Let me see beautiful those eyes again.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Succubus:  Heh… they are as beautiful as you, remember?', 'talking'=>true,'proc'=>nil},\
			],\
			'fear' =>\
			[\
				{'text'=>'  Suki1:  Let\'s take that off.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Succubus:  Ha, now I can see your pretty face again.', 'talking'=>true,'proc'=>method(:face_happy)},\
			],\
			'anger' =>\
			[\
				{'text'=>'  Suki1:  Let\'s take that off.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Succubus:  Heh, I was waiting for something to go “BUMP” in the the  night…', 'talking'=>true,'proc'=>nil},\
			],\
			'shyness' =>\
			[\
				{'text'=>'  Suki1:  Let\'s take that off.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'  Cillia:  Ah, thanks.', 'talking'=>true,'proc'=>method(:face_happy)},\
			]\
		},\
		{\
			'neutral' =>\
			...
			[\
				{'text'=>'Suki1:  I think you\'ve earned this~', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Succubus:  That blindfold\'s gonna look so good on you!', 'talking'=>true,'proc'=>method(:face_happy)},\
			]\
		},\
		{\
			'neutral' =>\
			...
			'happiness' =>\
			[\
				{'text'=>'  Suki1:  Raise in Shine!', 'talking'=>false,'proc'=>nil},\
