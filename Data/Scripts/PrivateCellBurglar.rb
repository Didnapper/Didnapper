...
{\
	...
	[\
		...
		[\
			{'text'=>'Suki1: So... I don\'t think I ever got your name...', 'talking'=>false,'proc'=>nil},\
			{'text'=>'Burglar: How about we keep it that way?', 'talking'=>true,'proc'=>nil},\
			{'text'=>'Suki1: How about I show you what a crotch rope is like?', 'talking'=>false,'proc'=>nil},\
			{'text'=>'Burglar: You didn\'t have to threaten me... It\'s Violet...', 'talking'=>true,'proc'=>nil},\
			{'text'=>'Suki1: Well, Violet, if you\'re a good girl, everything will work out fine, okay?', 'talking'=>false,'proc'=>nil},\
			{'text'=>'Burglar: Hah... I almost believed you!', 'talking'=>true,'proc'=>nil},\
		],\
	],\
	'charm' =>\
	[\
		{\
			...
			[\
				{'text'=>'Suki1: You know, you\'re pretty cute. Maybe you\'d have had more success stealing hearts instead of jewelry.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Whose heart would I have stolen, though?', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Suki1: Hm... maybe mine?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: I think I could still manage that.', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: You know, you\'re pretty cute. Maybe you\'d have had more success stealing hearts instead of jewelry.', 'talking'=>false,'proc'=>nil},\
		...
		{\
			'neutral' =>\
			[\
				{'text'=>'Suki1: I gotta say, I thought I was a pretty good escape artist until I met you. You could have made a career of it, like Houdini.', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				{'text'=>'Suki1: I\'m glad I finally caught you, a cutie like you doesn\'t belong in just any old jail.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: This doesn\'t feel like any jail I\'ve been in... Usually in jail they don\'t keep you tied up all the time.', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Suki1: Well, where\'s the fun in that?', 'talking'=>false,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1: I\'m glad I finally caught you, a cutie like you doesn\'t belong in just any old jail.', 'talking'=>false,'proc'=>nil},\
	...
	[\
		{\
			...
			[\
				{'text'=>'Suki1: Well, looks like I won our little game in the end.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: This will never be over, you and I both know that.', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Suki1: Sure, keep convincing yourself that.', 'talking'=>false,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: Well, looks like I won our little game in the end.', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				{'text'=>'Suki1: You know, you\'re only the second cutest thief I\'ve ever encountered.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: I bet she\'s nicer than you are...', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1: You know, you\'re only the second cutest thief I\'ve ever encountered.', 'talking'=>false,'proc'=>nil},\
	...
	[\
		{\
			...
			[\
				{'text'=>'Suki1: How about I take you back to one of your crime scenes and leave you tied up and gagged.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Honestly, I think I prefer you as a captor.', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: How about I take you back to one of your crime scenes and leave you tied up and gagged.', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				...
				{'text'=>'Suki1: I think that might be an upgrade, actually.', 'talking'=>false,'proc'=>nil},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1: You know I\'ve been thinking about getting a maid to clean these cells. What do you say, ready to pay your debt to society?', 'talking'=>false,'proc'=>nil},\
			...
			[\
				...
				{'text'=>'Suki1: Not anymore.', 'talking'=>false,'proc'=>nil},\
			],\
			'shyness' =>\
			[\
				{'text'=>'Suki1: You know I\'ve been thinking about getting a maid to clean these cells. What do you say, ready to pay your debt to society?', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				...
				{'text'=>'Suki1: That reminds me... I think I have an armbinder somewhere around here...', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: I don\'t think I want to know what that is.', 'talking'=>true,'proc'=>nil},\
			],\
			'shyness' =>\
			[\
				{'text'=>'Suki1: I don\'t like the idea of you escaping again. Hmmm... I wonder if I could get some chains in here...', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				...
				{'text'=>'Suki1: Who do you think I learned it from?', 'talking'=>false,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: You know, I\'ve got a cute thief friend who\'s dying to have some fun with you.', 'talking'=>false,'proc'=>nil},\
			...
			[\
				{'text'=>'Suki1: You know, I\'ve got a cute thief friend who\'s dying to have some fun with you.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Do you have to bring in someone else?', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Suki1: I figure I should give you a reason to be grateful for me.', 'talking'=>false,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1: You know, I\'ve got a cute thief friend who\'s dying to have some fun with you.', 'talking'=>false,'proc'=>nil},\
	...
	[\
		...
		{\
			...
			[\
				{'text'=>'Suki1: Punishment time!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Ouch! Man, jail\'s starting to look pretty good about now...', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1: Punishment time!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Untie me and try that again. I dare you.', 'talking'=>true,'proc'=>nil},\
			],\
			'shyness' =>\
			[\
				{'text'=>'Suki1: Punishment time!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Did you just slap my boobs?', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Suki1: What are you going to do about it?', 'talking'=>false,'proc'=>nil},\
			]\
		},\
		{\
			'neutral' =>\
		...
		{\
			...
			[\
				{'text'=>'Suki1: You\'ve been a very naughty girl.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Oof... Only as far as you know...', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1: You\'ve been a very naughty girl.', 'talking'=>false,'proc'=>nil},\
	...
	[\
		{\
			...
			[\
				{'text'=>'Suki1: Fun time!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: AHHAHAH – Quit it!', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: Fun time!', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				{'text'=>'Suki1: Let\'s see how ticklish you are!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: No wait, seriously, I can\'t take being tick- HAHAHAHAHA! Please have mercy! AHAHAHAHA!', 'talking'=>true,'proc'=>nil},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1: Let\'s see how ticklish you are!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: No wait, stop, I hate being tick- AHAHAHAHAH! Please stop! AHAHAHAHA!', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1: Let\'s see how ticklish you are!', 'talking'=>false,'proc'=>nil},\
	...
	[\
		{\
			...
			[\
				{'text'=>'Suki1: Mmmm, I\'ve been wanting to do this for a while...', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: What does- Mmph!', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Burglar: Speak for youself, pervert!', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: Mmmm, I\'ve been wanting to do this for a while...', 'talking'=>false,'proc'=>nil},\
		...
		{\
			'neutral' =>\
			[\
				{'text'=>'Suki1: Mmmm... You\'re my favorite captive~', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				{'text'=>'Suki1: Mmmm... I bet you\'ll like this~', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Mmmm... you know just how to make me feel better...', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1: Mmmm... I bet you\'ll like this~', 'talking'=>false,'proc'=>nil},\
	...
	[\
		{\
			...
			[\
				{'text'=>'Suki1: Lets take this off for a while.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Oh, thank the Lord.', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: Lets take this off for a while.', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				{'text'=>'Suki1: Okay, I\'ll let you talk for a while.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Oh, you\'ll let me huh? What, are you trying to be one of those dominatrix people or something?', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Suki1: Oh, are you trying to be one of those submissives?~', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Eep! No!', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: Okay, I\'ll let you talk for a while.', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				...
				{'text'=>'Suki1: Want to find out?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: N-no!', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1: I\'m going to ungag you now, but you better behave.', 'talking'=>false,'proc'=>nil},\
			...
			[\
				{'text'=>'Suki1: I\'m going to ungag you now, but you better behave.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Ugh, where do you find all these horrible things to put in my mouth?!', 'talking'=>true,'proc'=>nil},\
			]\
		},\
		{\
			'neutral' =>\
			...
			[\
				{'text'=>'Suki1: Hmmm, lets take this off, I wanna see your lips.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Planning to sneak another kiss, huh?', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1: Hmmm, lets take this off, I wanna see your lips.', 'talking'=>false,'proc'=>nil},\
	...
	[\
		{\
			...
			[\
				{'text'=>'Suki1: Lets see you steal what you can\'t see!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Get this thing off me! I was having a good time!', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: Lets see you steal what you can\'t see!', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				{'text'=>'Suki1: Close you eyes – never mind I\'ll do it for you.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Ohh, you can be quite the little dominatrix when you want to be...', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
			...
			[\
				{'text'=>'Suki1: Close your eyes – never mind I\'ll do it for you.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Hey! Stop playing with me!', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1: Close you eyes – never mind I\'ll do it for you.', 'talking'=>false,'proc'=>nil},\
	...
	[\
		{\
			...
			[\
				{'text'=>'Suki1: Okay lets take this off, for now...', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: For now...? Can it be forever?', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: Okay lets take this off, for now...', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				...
				{'text'=>'Suki1: That\'s what they all say.', 'talking'=>false,'proc'=>nil},\
			]\
		},\
		{\
			'neutral' =>\
		...
		{\
			...
			[\
				{'text'=>'Suki1: I wanna look you in the eye for this next part...', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Burglar: Oh... I think I want the blindfold back now...', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1: I wanna look you in the eye for this next part...', 'talking'=>false,'proc'=>nil},\
