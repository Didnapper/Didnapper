...
{\
	...
	[\
		...
		[\
			...
			{'text'=>'Mermaid: Yes?', 'talking'=>true,'proc'=>nil},\
		...
		[\
			...
			{'text'=>'Mermaid: Wait, what?', 'talking'=>true,'proc'=>nil},\
		]\
	],\
	'charm' =>\
	[\
		{\
			...
			[\
				...
				{'text'=>'Mermaid: Flattery? is that the best you have? But that\'s nice of you to say...', 'talking'=>true,'proc'=>nil},\
			...
			[\
				...
				{'text'=>'Mermaid: Then can you maybe untie me, please?', 'talking'=>true,'proc'=>nil},\
			...
			[\
				...
				{'text'=>'Mermaid: That\'s supposed to be the bright side?', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
		...
		{\
			...
			[\
				...
				{'text'=>'Mermaid.  Do you really mean that?', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Suki1: I do.', 'talking'=>false,'proc'=>nil},\
			],\
			'happiness' =>\
			[\
				{'text'=>'Suki1: You\'re really cute when you smile.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: That\'s nice of you to say. That made me a little happier...', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: Hey, I\'m sorry for being so mean.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: That\'s nice of you to make up for what you did to me... I guess.', 'talking'=>true,'proc'=>nil},\
			],\
			'fear' =>\
			[\
		...
		{\
			...
			[\
				{'text'=>'Suki1: You\'re really cute when you smile.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: That\'s kind  of you to say.', 'talking'=>false,'proc'=>nil},\
				],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: Don\'t be so sad. You have the cutest smile; it\'d be a shame not to show it.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: I\'m not sad!', 'talking'=>true,'proc'=>nil},\
			...
			[\
				...
				{'text'=>'Mermaid: Don\'t tell me what to do! I can frown as much as I want!', 'talking'=>true,'proc'=>nil},\
			]\
		},\
		{\
			'shyness' =>\
			[\
				{'text'=>'Suki1: You\'re just adorable when you blush.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Oh come on, now you\'re making me blush even more!', 'talking'=>true,'proc'=>nil},\
			...
			[\
				{'text'=>'Suki1: Don\'t be so sad. You have the cutest smile; it\'d be a shame not to show it.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: You really think that way about me?', 'talking'=>true,'proc'=>nil},\
			],\
			'fear' =>\
			[\
			...
			'anger' =>\
			[\
				{'text'=>'Suki1: Come on, turn that frown upside down.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Maybe you\'re not that bad after all...', 'talking'=>true,'proc'=>nil},\
			]\
		},\
	],\
	'insult' =>\
	[\
		{\
			...
			[\
				...
				{'text'=>'Mermaid: Hey! I like my hair!', 'talking'=>true,'proc'=>nil},\
			...
			[\
				...
				{'text'=>'Mermaid: Hey, that was really mean.', 'talking'=>true,'proc'=>nil},\
			],\
			'fear' =>\
			[\
			...
			[\
				...
				{'text'=>'Mermaid: Don\'t mock me... you will live to regret it.', 'talking'=>true,'proc'=>nil},\
			]\
		},\
		{\
			'shyness' =>\
			[\
				...
				{'text'=>'Mermaid: I-it\'s not revealing!', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Suki1: (She\'s really blushing now).', 'talking'=>false,'proc'=>nil},\
			],\
			'neutral' =>\
			[\
				{'text'=>'Suki1: You were surprisingly easy to capture for a magical mermaid.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Don\'t flatter yourself... you caught me off guard! In a fair fight you wouldn\'t stand a chance!', 'talking'=>true,'proc'=>nil},\
			],\
			'happiness' =>\
			[\
				{'text'=>'Suki1: You\'re so cute over there, all bound and helpless.', 'talking'=>false,'proc'=>nil},\
			...
			[\
				...
				{'text'=>'Mermaid: What did I do to deserve this treatment?', 'talking'=>true,'proc'=>nil},\
			],\
			'fear' =>\
			[\
			...
			[\
				...
				{'text'=>'Mermaid: Just shut up!', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Suki1: No, you shut up. Or better yet, I\'ll make you.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Ooh no! Don\'t even try!', 'talking'=>true,'proc'=>nil},\
			]\
		},\
		{\
			'shyness' =>\
			[\
				...
				{'text'=>'Mermaid: Don\'t be absurd, human.', 'talking'=>true,'proc'=>nil},\
			],\
			'neutral' =>\
			[\
			...
			[\
				...
				{'text'=>'Mermaid: Having to look at you - that\'s what I\'m getting angry about.', 'talking'=>true,'proc'=>nil},\
		...
		{\
			...
			[\
				{'text'=>'Suki1: I thought I was awesome but it turned out you were just pathetic.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: You\'re not very nice, are you?', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: Hey now, I was just investigating the cave. You were in there and just attacked me for no reason.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Because I... they... ugh...', 'talking'=>true,'proc'=>nil},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1: You\'re not as powerful as you think you are.', 'talking'=>false,'proc'=>nil},\
			...
			[\
				...
				{'text'=>'Mermaid: You like having all the power in your hands, don\'t you?', 'talking'=>true,'proc'=>nil},\
	...
	[\
		{\
			...
			[\
				...
				{'text'=>'Mermaid: Are you giving me a choice? Or are you just making fun of me and just going to gag me anyway, no matter what I say?', 'talking'=>true,'proc'=>nil},\
			...
			'sadness' =>\
			[\
				{'text'=>'Suki1: I think I might gag you now... I prefer listening to muffled screams.', 'talking'=>false,'anomaly'=>true,'proc'=>nil},\
			...
			[\
				...
				{'text'=>'Mermaid: W-w-what are you saying? You\'re not going to do anything to me, right? ...Right?', 'talking'=>true,'proc'=>nil},\
			...
			[\
				...
				{'text'=>'Mermaid: Don\'t you dare, bitch!', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Suki1: Watch your mouth; I\'m not the one tied up right now.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Just wait until I get out of this!', 'talking'=>true,'proc'=>nil},\
			]\
		},\
		{\
			'shyness' =>\
			[\
				{'text'=>'Suki1: How long do you think you can be ballgagged without hurting your jaw?', 'talking'=>false,'anomaly'=>true,'proc'=>nil},\
				{'text'=>'Mermaid: I don\'t want to find out.', 'talking'=>true,'proc'=>nil},\
			...
			[\
				{'text'=>'Suki1: I\'m a bit hungry. I could really go for some nice fish.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: The scary thing is I don\'t know if you\'re kidding or not.', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				...
				{'text'=>'Mermaid: Don\'t you dare put your hands on me!', 'talking'=>true,'proc'=>nil},\
			]\
		},\
		{\
			'shyness' =>\
			...
			'neutral' =>\
			[\
				{'text'=>'Suki1: Maybe I should take off those clothes and see what\'s underneath.', 'talking'=>false,'anomaly'=>true,'proc'=>nil},\
				{'text'=>'Mermaid: Are you serious? You don\'t get to see that! Get away from me!', 'talking'=>true,'proc'=>method(:face_angry)},\
				{'text'=>'Suki1: We\'ll get there soon enough, I suppose.', 'talking'=>false,'proc'=>nil},\
			],\
			'happiness' =>\
			[\
				{'text'=>'Suki1: How much tighter do you think I can make your bindings?', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Oh, come on! Aren\'t they tight enough already?', 'talking'=>true,'proc'=>nil},\
			...
			[\
				...
				{'text'=>'mermaid: No, please. I\'ll behave. I promise.', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
				{'text'=>'Suki1: (She\'s really struggling to get out).', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Suki1: If you keep trying to squirm out of those bindings I\'ll just have to add some more rope and put you into a strict hogtie to make sure you\'ll stay put.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Your threat does not faze me, bitch.', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Suki1: Looks like I\'ll have to teach you some manners, too.', 'talking'=>false,'proc'=>nil},\
			]\
		},\
		{\
			'shyness' =>\
			...
			[\
				...
				{'text'=>'Mermaid: Why...?', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: Do you know how much you\'d be worth? I might just sell you; you\'re one of the most extraordinary girls here.', 'talking'=>false,'proc'=>nil},\
			...
			[\
				{'text'=>'Suki1: (She\'s really struggling to get out).', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Suki1: If you keep trying to squirm out of those bindings I\'ll hang you from the ceiling like a fish.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: I\'m sure the rest of the guild would love to see you in that position, too.', 'talking'=>true,'proc'=>nil},\
				{'text'=>'Suki1: Yeah, well, I\'m the one doing the tying, so they don\'t get to see that.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: For now...', 'talking'=>true,'proc'=>nil},\
			]\
		},\
	],\
	'slap' =>\
	[\
		{\
			...
			[\
				{'text'=>'Suki1: Naughty girl! You deserve this!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Ah! Oww... You can stop now, you know.', 'talking'=>true,'proc'=>nil},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1: Naughty girl! You deserve this!', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				...
				{'text'=>'Mermaid: Hey! That hurts!', 'talking'=>true,'proc'=>nil},\
			],\
			'happiness' =>\
			[\
				{'text'=>'Suki1: Naughty girl! You deserve this!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: How can you be enjoying this?', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: Naughty girl! You deserve this!', 'talking'=>false,'proc'=>nil},\
			...
			[\
				{'text'=>'Suki1: Naughty girl! You deserve this!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Ahhh! Ahh!', 'talking'=>true,'proc'=>nil},\
			]\
		},\
		{\
			'shyness' =>\
			...
			[\
				{'text'=>'Suki1: Naughty girl! You deserve this!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Oww! What are you doing?!', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: Naughty girl! You deserve this!', 'talking'=>false,'proc'=>nil},\
			...
			[\
				{'text'=>'Suki1: Naughty girl! You deserve this!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Do I have a say in this?', 'talking'=>true,'proc'=>nil},\
		...
		{\
			...
			[\
				{'text'=>'Suki1: Naughty girl! You deserve this!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Hey! Don\'t do that!', 'talking'=>true,'proc'=>nil},\
			],\
			'happiness' =>\
			[\
				{'text'=>'Suki1: Naughty girl! You deserve this!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Ow! Maybe ask first!', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: Naughty girl! You deserve this!', 'talking'=>false,'proc'=>nil},\
			...
			[\
				{'text'=>'Suki1: Naughty girl! You deserve this!', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Don\'t you dare touch me again.', 'talking'=>true,'proc'=>nil},\
			]\
		},\
	],\
	'tickle' =>\
	...
	[\
		{\
			...
			[\
				...
				{'text'=>'Mermaid: Hey! Did I give you permission to kiss me?', 'talking'=>true,'proc'=>nil},\
			],\
			'neutral' =>\
			[\
			...
			[\
				...
				{'text'=>'Mermaid: Mm... Are you trying to make me not hate you?', 'talking'=>true,'proc'=>nil},\
			...
			[\
				...
				{'text'=>'Mermaid: Mmmh... Please get off me.', 'talking'=>true,'proc'=>nil},\
			],\
			'anger' =>\
			[\
		...
		{\
			...
			[\
				...
				{'text'=>'Mermaid: Mmh... Can you maybe ask before doing something like that?', 'talking'=>true,'proc'=>nil},\
			],\
			'neutral' =>\
			[\
			...
			[\
				...
				{'text'=>'Mermaid: There\'s no way I\'m letting you get out of this one.', 'talking'=>true,'proc'=>nil},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1: Mmm....', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				{'text'=>'Suki1: Mmmm...', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Mmm... You\'re getting a bit ahead of yourself!', 'talking'=>true,'proc'=>nil},\
			],\
			'happiness' =>\
			[\
				{'text'=>'Suki1: Mmm...', 'talking'=>false,'proc'=>nil},\
			...
			[\
				{'text'=>'Suki1: Mmm...', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Mmm... So that\'s what humans taste like.', 'talking'=>true,'proc'=>method(:face_happy)},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1: Mmmm...', 'talking'=>false,'proc'=>nil},\
			...
			[\
				{'text'=>'Suki1: Come here.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Don\'t you- mmmm?! Mmm...', 'talking'=>true,'proc'=>nil},\
			]\
		},\
	],\
	'ungag' =>\
	[\
		{\
			...
			[\
				...
				{'text'=>'Suki1: You don\'t seem to mind that much, though.', 'talking'=>false,'proc'=>nil},\
			],\
			'neutral' =>\
			[\
			...
			[\
				...
				{'text'=>'Suki1: You kinda answered your own question...', 'talking'=>false,'proc'=>nil},\
			],\
			'fear' =>\
			[\
			...
			[\
				...
				{'text'=>'Suki1: If I\'d known you would go on whining like this, I wouldn\'t have ungagged you...', 'talking'=>false,'proc'=>nil},\
			]\
		},\
		{\
			'shyness' =>\
			...
			[\
				{'text'=>'Suki1: I suppose I can take this off for a while.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Well, thank you for that, I guess.', 'talking'=>true,'proc'=>nil},\
			],\
			'happiness' =>\
			[\
				{'text'=>'Suki1: I suppose I can take this off for a while.', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				{'text'=>'Suki1: I suppose I can take this out for a while.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: You like the way that gag looks on me?', 'talking'=>true,'proc'=>nil},\
			],\
			'neutral' =>\
			[\
				{'text'=>'Suki1: I suppose I can take this out for a while.', 'talking'=>false,'proc'=>nil},\
			...
			[\
				{'text'=>'Suki1: I suppose I can take this out for a while.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: I guess that wasn\'t so bad... but can we please have a break from those things?', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: I suppose I can take this out for a while.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Hpmh...  Th-thanks?', 'talking'=>true,'proc'=>nil},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1: (She looks really frightened)', 'talking'=>true,'proc'=>nil},\
	...
	[\
		...
		{\
			...
			[\
				{'text'=>'Suki1: Nighty night.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: I don\'t like being blindfolded.', 'talking'=>true,'proc'=>nil},\
			],\
			'neutral' =>\
			[\
				{'text'=>'Suki1: Nighty night.', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				{'text'=>'Suki1: Lights out, sweetheart.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: I like this, but only a little bit.', 'talking'=>true,'proc'=>nil},\
			],\
			'sadness' =>\
			[\
				{'text'=>'Suki1: Sorry for this.', 'talking'=>false,'proc'=>nil},\
	...
	[\
		...
		{\
			...
			[\
				{'text'=>'Suki1: Let\'s see those cute eyes.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Thank you, I guess.', 'talking'=>true,'proc'=>nil},\
			],\
			'happiness' =>\
			[\
			...
			[\
				{'text'=>'Suki1: Let\'s see those cute eyes.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: That\'s nice of you, but it\'s not like you\'re going to untie me, is it?', 'talking'=>true,'proc'=>nil},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1: Let\'s see those cute eyes.', 'talking'=>false,'proc'=>nil},\
		...
		{\
			...
			[\
				{'text'=>'Suki1: Let\'s see those cute eyes.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: Ok, I guess... it\'s not like I\'m afraid of the dark or something.', 'talking'=>true,'proc'=>nil},\
			],\
			'neutral' =>\
			[\
				{'text'=>'Suki1: Let\'s see those cute eyes.', 'talking'=>false,'proc'=>nil},\
			...
			[\
				{'text'=>'Suki1: Let\'s see those cute eyes.', 'talking'=>false,'proc'=>nil},\
				{'text'=>'Mermaid: *Yawn* It\'s morning already?', 'talking'=>true,'proc'=>nil},\
			],\
			'fear' =>\
			[\
				{'text'=>'Suki1: Let\'s see those cute eyes.', 'talking'=>false,'proc'=>nil},\
